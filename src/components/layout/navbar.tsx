      ...
      <Container className="flex h-16 items-center justify-between md:h-[72px]">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden h-10 w-10 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-white/5 hover:text-foreground sm:flex"
            aria-label="GitHub"
          >
            <Github size={18} />
          </a>
